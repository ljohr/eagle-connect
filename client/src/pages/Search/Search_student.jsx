      ...
      <main className='student-search'>
        <section id="search">
          <form action="#" method="get" onSubmit = {handleSearch}>
            <div id="search-bar">
              ...
              <select id="selectMajor" name="selectMajor" onChange={(e) => setMajor(e.target.value)}>
            ...
            <div id="search-bar">
              ...
              <select id="selectSector" name="selectSector" onChange={(e) => setSector(e.target.value)}>
            ...
            <div id="search-bar">
              ...
              <select id="selectType" name="selectType" onChange={(e) => setType(e.target.value)}>
        ...
        <section id="info">
            ...
            return (
              <div className="alumni-block" key={user._id}>
                ...
                <div className="info">
                  ...
                  <p>{user.sector} | Major: {user.major} </p>
                  <p>{user.about}</p>
          ...
          <div className="alumni-block">
            <img src="https://cdn.glitch.global/82f4f962-cdd9-458c-be3f-2ad300c125e2/image_profile1.jpeg?v=1701641843199" alt="Profile Picture" />
          
            <div className="info">

              <h2>Keith Scott</h2>
              <p>Software Engineer | Major: Computer Science</p>
              <p>I would be happy to give advice to prospective software engineers.</p>
              <div className="features">
                <div className="feature">
          ...
          {/* person2 */}
          <div className="alumni-block">
            <img src="https://cdn.glitch.global/06dd22aa-8255-4329-8c9e-4213dfe9151b/Three-Things-To-Consider-When-Deciding-On-Your-LinkedIn-Profile-Picture-1024x1024.jpg?v=1700436493589" alt="Profile Picture" />
            <div className="info">
              <h2>Bella Ye</h2>
          ...
          {/* person3 */}
          <div className="alumni-block">
            <img src="https://cdn.glitch.global/06dd22aa-8255-4329-8c9e-4213dfe9151b/004.webp?v=1700436521470" alt="Profile Picture" />
            <div className="info">
              <h2>Mali Wilson</h2>
